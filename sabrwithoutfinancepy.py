...
# we Set up market data
spot = 100.0
risk_free_rate = 0.01
dividend_yield = 0.0
atm_volatility = 0.20

# we Set up VarSwap parameters (for the fixed rate it would be good to change it)
...
# input SABR model parameters
beta = 0.7
rho = -0.3
nu = 0.5
volvol = 0.5

# Let's set up volatility surface parameters
strikes = np.arange(50, 151, 5)
expiries = np.arange(0.25, 2.51, 0.25)

# Now we Define the SABR model function
...
# fair values and comparison with ATMI
print("*** SABR Model Results ***")

# We Calculate VarSwap fair value
...
# We Calculate VolSwap fair value
...
# Print the Comparison with ATMI
